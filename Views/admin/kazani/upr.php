...
$container .= '<tr><td colspan="2"><input type="submit" value="uložit" name="save"><input type="submit" value="připojit přílohu" name="attachment"><input type="submit" value="smazat" name="delete"></td></tr>';
$container .= '</table>';
$container .= '</form>';
